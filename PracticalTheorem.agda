...
module PracticalTheorem where

practical-imperfect-theorem : {st st₁ st₂ : ST}
                              → (ε : 𝕌) (m : ℕ)
                              → (Φ : Y st₁ st₂ → Y st₁ st₂ → 𝕌)
...
practical-imperfect-theorem {st} {st₁} {st₂} ε m Φ cᴸ = reg , γ where
  X = ST-Type st
...
practical-perfect-theorem : {st st₁ st₂ : ST}
                              → (ε : 𝕌) (m : ℕ)
                              → (Φ : Y st₁ st₂ → Y st₁ st₂ → 𝕌)
                              → (cᴸ : continuousᴸ st₁ st₂ Φ)
                              → Σ \(reg : regressor st st₁ st₂)
...
practical-perfect-theorem {st} {st₁} {st₂} ε m Φ cᴸ = reg , γ where
    theorem = practical-imperfect-theorem {st} {st₁} {st₂} ε m Φ cᴸ
    reg : regressor st st₁ st₂
    reg = pr₁ theorem
